...
#define FLD_SCENARIO_EFFECTIVENESSVARIABLE "EFFECTIVENESSVARIABLE"
#define FLD_SCENARIO_CHANGEFREQUENCY "CHANGEFREQUENCY"
#define FLD_SCENARIO_CHANGETIMES "CHANGETIMES"
#define FLD_SCENARIO_MTEFFECT "RAISE_BY_MT"
